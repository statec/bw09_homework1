...
test_object("index4")
test_object("aktien")
test_function("mean", index = 1, args = c("x"),eval=FALSE)
test_function("mean", index = 2, args = c("x"),eval=FALSE)
test_function("mean", index = 3, args = c("x"),eval=FALSE)
test_function("mean", index = 4, args = c("x"),eval=FALSE)
